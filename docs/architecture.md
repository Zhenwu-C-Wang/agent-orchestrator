...
- `app.py` for a guided Streamlit console with workflow preview, route warnings, run history, acceptance and cache inspection, per-case/per-entry drill-downs, and exportable run/acceptance/cache artifacts
